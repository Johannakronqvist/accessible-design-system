      ...
      <div className="ds-wrap">
        ...
        >
          <div>
            ...
            <p className="ds-sub">
              Color, type, shape, density and more are each a single token.
              Change one and the whole system re-tunes - and it can never ship
              below WCAG AA.
            </p>
          </div>
  ...
  <Button>Save changes</Button>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              <div className="ds-derive" style={{ marginBottom: 18 }}>
                <div className="ds-derive-cell">
                  ...
                  <span className="ds-read">
                    ...
                    <span
                      className="pass"
                      style={{
                        background: rPicked >= 4.5 ? "#15803D" : "#B4322F",
                      }}
                    >
                ...
                <div className="ds-derive-cell">
                  ...
                  <div className="ds-derive-row">
                    ...
                    />
                    <span className="ds-swhex">{tokens["--accent-fill"]}</span>
                  </div>
                  <span className="ds-read">
                    {rFill.toFixed(1)}:1{" "}
                    <span
                ...
                <div className="ds-derive-cell">
                  ...
                  <div className="ds-derive-row">
                    ...
                    />
                    <span className="ds-swhex">{tokens["--accent-text"]}</span>
                  </div>
                  <span className="ds-read">
                    {rText.toFixed(1)}:1{" "}
                    <span
                  ...
                  <span className="ds-derive-note">on the page background</span>
                </div>
              </div>
              ...
              <p className="ds-hint" style={{ margin: "0 0 18px" }}>
                ...
                deriveAccent keeps the hue you chose and walks the lightness
                until white text on it clears 4.5:1 - down for a pale color, up
                for one that is already very dark. It stops at the first shade
                that passes rather than the darkest available, so the result
                stays as close to your choice as the ratio allows.
              </p>
              <p className="ds-hint" style={{ margin: "0 0 18px" }}>
                That is the difference between picking a color and deriving one.
                Because the search targets a contrast ratio rather than a fixed
                shade, there is no brand color you can type in that drops the
                system below AA - and every component below re-tunes from the
                derived tokens, never from what you picked.
              </p>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card" style={{ maxWidth: 470 }}>
              ...
              >
                Change the brand color or toggle light and dark above - the
                tokens flow through every element below without touching a line
                of component code.
              </p>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              <p className="ds-hint">
                Display uses {p.fonts.display.split(",")[0].replace(/'/g, "")},
                body uses {p.fonts.body.split(",")[0].replace(/'/g, "")}. Both
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              <p className="ds-hint">
                Here the gap uses space-3 and the padding uses space-4 - change
                the base unit to watch the rhythm expand or tighten.
              </p>
            </div>
          </div>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              <p className="ds-hint">
                Focus and active respond live above; disabled is exempt from
                contrast and blocks interaction; loading sets aria-busy and
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              <p className="ds-hint">
                Label, hint and error are wired through aria-describedby and
                aria-invalid; the error carries an icon and message, never color
                alone (1.4.1); required is announced to assistive tech; the
                border meets 3:1 and the field is a 44px touch target. Tab
                through to try.
              </p>
            </div>
          </div>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              <p className="ds-hint">
                The Field shell applied to a multi-line input. The counter is
                described to the field, so focusing it announces the budget, and
                a separate polite region only speaks in the last 20 characters -
                typing is never narrated keystroke by keystroke. With
                enforceMax=false the limit is advisory: going over sets
                aria-invalid and shows the error instead of silently truncating
                pasted text.
              </p>
            </div>
          </div>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              <p className="ds-hint">
                A labelled input inside a role=search landmark. The clear button
                only exists when there is something to clear, carries a label,
                and returns focus to the input - the browser's own WebKit clear
                affordance is hidden because it can't be reached by keyboard.
                Pass resultCount for a polite status region that announces how
                many results came back without moving focus.
              </p>
            </div>
          </div>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              <p className="ds-hint">
                Built for 3.3.8 Accessible Authentication, which most password
                fields fail: paste is never intercepted, autoComplete is set so
                managers can fill and save, and the reveal toggle lets people
                verify what they typed rather than rely on memory. The toggle is
                a button with aria-pressed; each requirement pairs an icon with
                text so the met state never rests on color, and a polite summary
                reports progress instead of re-reading the whole list on every
                keystroke.
              </p>
            </div>
          </div>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              <p className="ds-hint">
                A native input[type=range], which is the whole accessibility
                argument: arrows, Home / End and Page Up / Down move it, and a
                click anywhere on the track jumps to that value - so nothing
                here requires a drag (2.5.7) or a path-based gesture (2.5.1).
                formatValue feeds aria-valuetext, so Density announces
                “Comfortable” rather than “3”. The thumb is a 24px target and
                the filled track meets 3:1 against the empty one.
              </p>
            </div>
          </div>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              />
              <p className="ds-hint">
                Drag and drop is an enhancement here, never the only way in. The
                primary control is a real file input paired with a label, so the
                same action works by keyboard, click and touch with no dragging
                at all (2.5.7) - the input stays in the tab order and draws its
                focus ring on the label. Chosen files are text with a labelled
                remove button each, and a polite region reports what was added,
                rejected or removed, so the outcome of a drop is never carried
                by the visual list alone.
              </p>
            </div>
          </div>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              <p className="ds-hint">
                ...
                spinbutton role, min / max / step and value announcements for
                free. The − and + buttons are the pointer and touch addition -
                44px each, labelled with what they change rather than a bare
                symbol. At the bounds they report aria-disabled instead of
                taking the disabled attribute, so pressing + up to the maximum
                announces the state without dropping your focus onto the body.
                Typing is left alone while the field has focus and clamped on
                blur, so entering “12” in a field with a minimum of 5 isn't a
                fight with the clamp.
              </p>
            </div>
          </div>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              <p className="ds-hint">
                A fieldset with a legend, so related controls are announced as
                one named group and the hint is read once for the group instead
                of repeated on every field. The sameAs slot is the 3.3.7
                Redundant Entry answer: when the information was already given,
                offer it back rather than ask again - unchecking it restores the
                fields, checking it unmounts them so they leave the tab order
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              <p className="ds-hint">
                ...
                association and the shared focus ring; a 24px+ hit target wraps
                each control. The checkbox radius follows the Shape token but
                clamps to a rounded-square, so it never collides with radios at
                the pill setting - flip Shape above to try it.
              </p>
            </div>
          </div>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              <p className="ds-hint">
                ...
                move with the arrows, Home / End and type-ahead, choose with
                Enter, dismiss with Escape - and focus returns to the trigger.
                Selected is marked with a check, never color alone. It reuses
                the Field label / hint / error wiring, the focus ring, and the
                shape token.
              </p>
            </div>
          </div>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              <p className="ds-hint">
                ...
                across six tones (neutral, accent, success, warning, danger,
                info) and verified in light and dark. The label always states
                the meaning, so nothing depends on color alone, and the tag's ×
                is a real button with an aria-label. Radius follows the shape
                token.
              </p>
            </div>
          </div>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              <p className="ds-hint">
                ...
                severity never rests on color alone - the icon is sized up as
                the primary non-color cue. The dismiss is a real 24px button
                with an aria-label and focus ring. Pass live="assertive"
                (role=alert) or live="polite" (role=status) for alerts inserted
                dynamically; static callouts stay silent to assistive tech.
                Verified AA in light and dark.
              </p>
            </div>
          </div>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              >
                ...
                <Link href="#link">underline is the default</Link> rather than
                an option. Where a link is already distinguishable by position -
                a row of nav items, a footer column - the quieter{" "}
                <Link href="#link" underline="hover">
                  hover underline
                </Link>{" "}
                is available. External links get an icon plus text saying they
                open a new tab, like{" "}
              ...
              <p className="ds-hint">
                Colour alone never distinguishes a link from its surrounding
                text. external also sets rel="noopener noreferrer", and adds the
                new-tab warning as real text rather than a title attribute, so
                it is announced rather than sprung on you (3.2.5).
              </p>
            </div>
          </div>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              >
                There is a live skip link on this page - it is the first thing
                in the tab order. Click here, then press{" "}
                <kbd className="ds-kbd">Shift</kbd> +{" "}
                <kbd className="ds-kbd">Tab</kbd> until it slides into the
                top-left corner.
              </p>
              <p className="ds-hint">
                The cheapest win in the system (2.4.1 Bypass Blocks). It is
                hidden with transform rather than display:none, because the
                latter would take it out of the tab order and defeat the point.
                Give the target tabIndex={-1} too, or some browsers scroll
                without moving focus and the next Tab sends you back to the top
                of the page.
              </p>
            </div>
          </div>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              />
              <p className="ds-hint">
                An ordered list inside a labelled nav landmark, because the
                order is the information. The current page is the last item and
                is not a link - it carries aria-current="page" and renders as
                text, so nobody tabs to a link that goes where they already are.
                Separators are hidden from assistive tech; the list structure
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              <p className="ds-hint">
                Every control has a real name: the numbered buttons are labelled
                “Page 3”, not “3”, so a list of bare digits still makes sense
                out of context. The current page is marked with aria-current, a
                soft tint and a step up in weight, so position never rests on
                colour - and the 32px targets follow the Shape token closely
                enough to read as circles at the Pill setting. Previous and Next
                report aria-disabled at the ends rather than taking the disabled
                attribute, so paging to the last page never drops your focus
                onto the body.
              </p>
            </div>
          </div>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              />
              <p className="ds-hint">
                A roving tabindex keeps the whole tablist to a single stop in
                the tab order, so Tab moves from the tabs into the panel rather
                than through every tab in turn. The selected tab shows an
                indicator bar and a weight change as well as colour. The panel
                takes tabindex={0} so it can be reached and scrolled by keyboard
                even when it holds nothing focusable.
              </p>
            </div>
          </div>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              />
              <p className="ds-hint">
                Each trigger is a real button wrapped in a heading - the part
                most implementations miss. Without it, the heading shortcut
                can't jump between sections and the page outline has a hole.
                headingLevel is a prop because the right level depends on where
                the accordion sits. Set allowMultiple to turn the accordion into
          ...
          <div className="ds-section">
            ...
            <p className="ds-hint">
              ...
              landmark list that reads “navigation, navigation, navigation” is
              useless. The active item carries aria-current="page" plus a weight
              step and an underline, so it never rests on colour - click between
              Projects, Reports and Team to watch it move. Narrow the window
              below 768px and the links collapse behind a toggle.
            </p>
            <p className="ds-hint">
              onNavigate(href, event) is what makes that work: without it the
              items are plain anchors and the browser navigates, which is the
              right default; with it a router can preventDefault and push
              instead. It also closes the collapsed row, since leaving it open
              would cover the page you just asked for. SideNav takes the same
              prop.
            </p>
            <p className="ds-hint">
              That collapsed panel is a <em>non-modal</em> disclosure, not a
              dialog: focus is not trapped and the page behind stays reachable,
              which is right for a panel that pushes content down rather than
              covering it. Escape closes it and returns focus to the toggle. A
              full-screen drawer that covers the page would need a focus trap
              and an inert background - that is Modal's job, and this component
              deliberately doesn't pretend to do it.
            </p>
          </div>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              <p className="ds-hint">
                This is not Select. A listbox picks a value and keeps focus on
                its trigger, driving the list with aria-activedescendant; a menu
                fires actions, so real DOM focus moves onto each item and a
                screen reader reads them as commands. Open with click, Enter,
                Space or ↓ - or ↑ to land on the last item. Arrows, Home / End
                and type-ahead move; Escape or Tab dismiss, and focus returns to
                the trigger. Disabled items keep their place and report
                aria-disabled rather than vanishing, so the menu doesn't change
                shape under you.
              </p>
            </div>
          </div>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              <p className="ds-hint">
                ...
                section would clog the landmark list, so this renders a single
                labelled nav containing one list per group, each pointed at its
                own heading with aria-labelledby - real structure without
                inventing landmarks. Group labels are plain text rather than
                headings by default, since a sidebar's “Workspace” and “Account”
                usually aren't part of the document outline; pass headingLevel
                when the sidebar genuinely is the page structure.
              </p>
            </div>
          </div>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              <p className="ds-hint">
                Radiogroup semantics rather than a row of aria-pressed buttons,
                because that is what the control is - one choice out of several,
                not several independent toggles. The keyboard difference is the
                real payoff: a roving tabindex makes the group a single stop in
                the tab order with the arrows moving between options, so a
                five-option switcher costs one Tab instead of five. The four
                switchers at the top of this page are this component - arrow
                through them.
              </p>
            </div>
          </div>
          ...
          <div className="ds-section">
            ...
            */}
              ...
              <p className="ds-hint">
                A native <span className="ds-mono">&lt;dialog&gt;</span> opened
                with <span className="ds-mono">showModal()</span>, which is the
                whole point: the browser supplies a real focus trap, an inert
                background - content behind is unreachable by keyboard and
                hidden from assistive tech, with no aria-hidden bookkeeping -
                Escape to dismiss, and focus returning to whatever opened it.
                Tab around inside one and you will not get out.
              </p>
              <p className="ds-hint">
                The quieter win is top-layer rendering. A hand-rolled div modal
                sits in the normal stacking context, so any ancestor with
                overflow:hidden, a transform or a competing z-index can clip it
                - a common and hard-to-spot 2.4.11 failure. A dialog in the top
                layer cannot be clipped by anything, which is why Modal claims
                2.4.11 outright where Select only claims it in part.
              </p>
              <p className="ds-hint">
                The same trade as Slider comes with it: jsdom implements neither
                showModal() nor the top layer, so the trap and the inert
                background are verified by hand rather than in CI. The suite
                covers what is ours - labelling, initial focus, scroll lock,
                backdrop dismissal, and keeping React state in step with the
                browser's own close.
              </p>
            ...
            <div className="ds-card">
              <Grid min={230}>
                ...
                <Card padding="md" title="Avatar sizes" headingLevel={4}>
                  ...
                  <Text size="sm" tone="muted">
                    Flip Shape above - avatars read the token raw, so Pill makes
                    them circles.
                  </Text>
                  <Divider emphasis="strong" spacing="md" />
                  <Text size="sm" tone="muted">
                    Above: emphasis="strong", for rules that separate regions.
                  </Text>
                </Card>
              </Grid>
              <p className="ds-hint">
                Card owns the <span className="ds-mono">.ds-card</span> class
                this guide uses 33 times, which until now lived only in the
                guide's own CSS. Its padding is a token rather than a number, so
                density follows the spacing unit with everything else. Avatar
                reads <span className="ds-mono">--radius</span> raw and
                unclamped - a rounded square at Sharp, a circle at Pill - which
                makes it the clearest demonstration of the shape token in the
                system.
              </p>
              <p className="ds-hint">
                Spinner uses role="status", so its label is announced politely
                when it appears; a bare spinning icon with no accessible name is
                silence to a screen reader. Under prefers-reduced-motion the
                animation stops <em>and</em> the label becomes visible, so the
                meaning survives the motion being removed rather than going with
                it. Divider is an <span className="ds-mono">&lt;hr&gt;</span>{" "}
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              <Stack gap="16px">
                ...
                <Text measure>
                  Text carries the body face, a line height tuned for reading,
                  and an optional measure that caps the line near 65 characters
                  - the width at which running text stays comfortable.
                </Text>
                <Text size="sm" tone="muted">
              ...
              <p className="ds-hint">
                The prop that looks redundant is the important one. Heading
                takes <span className="ds-mono">level</span> and{" "}
                <span className="ds-mono">size</span> separately, because they
                answer different questions: level is where this sits in the
                document outline, size is how big it looks. Conflating them is
                the most common heading-order bug there is - someone wants
                smaller text, picks an h4 under an h2, and quietly breaks the
                outline screen reader users navigate by. Keep the level correct
                and shrink the size instead, as the third line above does.
              </p>
            </div>
          </div>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              <p className="ds-hint">
                The layout primitives - Container, Stack, Cluster and Grid - are
                fluid with no breakpoints required: the Grid collapses to a
                single column instead of overflowing, so content reflows cleanly
                down to 320px and at 400% zoom (1.4.10). Controls also grow to
                44-48px touch targets on touch devices, and the shared
                breakpoints above are there for the few layouts that need
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              <p className="ds-hint">
                Still your responsibility at the app level: alt text, captions,
                heading and reading order, page language, the wording of error
                messages, and testing with real assistive technology.
              </p>
            </div>
          </div>
          ...
          <div className="ds-section">
            ...
            <div className="ds-card">
              ...
              >
                One source of truth for what the system satisfies and what stays
                your responsibility. It drives the automated test gate and the
              ...
              <p className="ds-hint">
                ...
                eslint-plugin-jsx-a11y into CI so nothing merges below bar.
              </p>
            </div>
          </div>
